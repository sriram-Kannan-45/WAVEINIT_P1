/**
 * Language Templates and Code Initialization Utility
 * ──────────────────────────────────────────────────
 * Provides language-specific default Starter Code and Reference Solution
 * templates for all supported programming languages.
 */
...
/**
 * Returns default starter code for a given language and problem
 */
export function getDefaultStarterCode(lang, problem) {
  const p = problem || {};
